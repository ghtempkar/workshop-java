...
//
//internal class TestingJwtAuthenticationFilter(jwtTokenUtil: JwtTokenRS256, userDetailsService: UserDetailsService) :
//    JwtAuthenticationFilter2(jwtTokenUtil, userDetailsService) {
...
//
//    private lateinit var jwtTokenUtil: JwtTokenRS256
...
//    @BeforeEach
//    fun setUp() {
//        jwtTokenUtil = mock(JwtTokenRS256::class.java)
